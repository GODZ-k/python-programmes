...
def TaskExe():
    ...
    def Music():
        ...
        if 'Tere_Ishq_Main' in musicName:
            os.startfile('F:\\Music\\2014\\Tere_Ishq_Main.mp3')

        elif 'Dekh Lena' in musicName:
            os.startfile('F:\\Music\\Audio\\Dekh Lena.mp3')
    ...
    def OpenApps():
        ...
        if 'code' in query:
            os.startfile("C:\\Users\\Amit Maurya\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe")
    ...
    def Tran():
        ...
        Text = result.text
        Speak(Text)
        Speak("Translation for this Line is:"+Text)
    ...
    def screenshot():
        ...
        path = takecommand()
        path1name = path + ".png"
        path1 = "E:\p0ythontry"+ path1name
        kk = pyautogui.screenshot()
        kk.save(path1)
        os.startfile("E:\pythontry")
    ...
    while True:
        ...
        if 'hello' in query:
            Speak("Hello Sir , I Am Jarvis Always Avaliable for you. Any Where Any Time just call me i will be There")
